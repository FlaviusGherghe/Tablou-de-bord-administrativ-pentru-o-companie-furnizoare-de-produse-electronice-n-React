...
import "./modificacomenzi.scss"

const Modificacomenzi = () => {
    ...
    const comenziId = location.pathname.split("/")[2];
    ...
    const handleClick = async (e) => {
        ...
        try {
            await axios.put(`http://localhost:8800/comenzi/${comenziId}`, {
                icon: file ? iconUrl : "",
                ...row,
            });
            navigate("/comenzi");
    ...
    return (
        ...
        <Sidebar />
        <div className="containerModificaComenzi">
          <Navbar />
...
export default Modificacomenzi